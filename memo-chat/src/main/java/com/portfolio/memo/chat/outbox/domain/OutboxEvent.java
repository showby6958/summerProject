...
public class OutboxEvent {
            ...
            String payload)
    {
        ...
        e.attemptCount = 0;
        e.nextRetryAt = Instant.now(); // 즉시 발행 대상
    ...
    public void markSent(Instant now, String streamRecordId) {
    ...
    public void markPendingRetry(Instant nextRetryAt, String lastError) {
    ...
    public void markDead(Instant now, String lastError) {
